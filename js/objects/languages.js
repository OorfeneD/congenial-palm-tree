  ...
  ru: {
    ...
    help: {
      ...
      settings: {
        ...
        cookie_sortGraph: "Сортировать по<br>количеству",
        cookie_scrollTop: "Кнопка<br>«Наверх»",
        cookie_theme: "Таймер тем",
      },
      sort: {
  ...
  en: {
    ...
    help: {
      ...
      settings: {
        ...
        cookie_username: "Show usernames",
        cookie_sortGraph: "Sort by<br>quantity",
        cookie_scrollTop: "Button «Up»",
        cookie_theme: "Theme timer",
      },
      sort: {
