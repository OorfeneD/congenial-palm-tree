...
////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            for(let i = 0; i < Object.keys(memes).length; i++){
              ...
              allMaxLine += `<dot meme="m${i}" memename="${Object.keys(memes)[i]}" style="bottom: ${dmax*2+10 > 207 ? 207 : dmax*2+10}px; background: ${infoBot["memes"][Object.keys(infoBot["memes"])[i]]};" alt="${dmax}" hover="0" onclick="dotclick(this);"></dot>`;
            }  
